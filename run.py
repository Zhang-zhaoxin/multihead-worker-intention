...
from model import CNN_Multihead
...
class Learner:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--dataset", type=str, default="data/selected_keyframes", help="Path to dataset")
        ...
        parser.add_argument("--training_iterations", "-i", type=int, default=1000, help="Number of meta-training iterations.")
        ...
        parser.add_argument("--query_per_class", "-qpc", type=int, default=1, help="Target samples (i.e. queries) per class used for training.")
        ...
        parser.add_argument("--backbone", choices=["resnet18", "resnet34", "resnet50"], default="resnet18", help="backbone")
